# web-internationalization Specification

## Purpose
Define frontend internationalization behavior for `machado-web`, including locale resolution, persistence, translated UI resources, and accessible language switching without backend changes.
